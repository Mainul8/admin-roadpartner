  ...
  return (
    ...
    <div className="mb-6 flex flex-col gap-5.5 sm:flex-row">
      <div className="w-full sm:w-1/2">
        ...
        >
          <option value="" disabled className="text-body dark:text-bodydark">Select State</option>
          <option value="US" className="text-body dark:text-bodydark">US</option>
          <option value="Canada" className="text-body dark:text-bodydark">Canada</option>
        </select>
        <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">
      ...
      <div className="w-full sm:w-1/2">
        ...
        >
          <option value="" disabled className="text-body dark:text-bodydark">Select City</option>
          <option value="US" className="text-body dark:text-bodydark">US</option>
          <option value="Canada" className="text-body dark:text-bodydark">Canada</option>
        </select>
        <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">

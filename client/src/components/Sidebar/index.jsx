...
import Logo from '../../images/logo/rd-logo.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-newColor duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-md font-bold text-black dark:text-white">
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-bold text-black duration-300 ease-in-out  hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                          (pathname === '/' ||
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/dashboard/roadpartner"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-bold text-black duration-300 ease-in-out dark:text-white hover:text-white ' +
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-bold text-black duration-300 ease-in-out hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                    pathname.includes('calendar') &&
                    'bg-white dark:bg-primaryColor'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-bold text-black duration-300 ease-in-out hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                    pathname.includes('profile') && 'bg-white dark:bg-primaryColor'
                  }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/forms/blogs"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-bold text-black dark:text-white duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-orangeColor')
                              }
                            >
                              Blogs
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-bold text-black duration-300 ease-in-out hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                    pathname.includes('tables') && 'bg-white dark:bg-primaryColor'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-bold text-black duration-300 ease-in-out hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                    pathname.includes('chart') && 'bg-white dark:bg-primaryColor dark:primaryColor'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-bold text-black duration-300 ease-in-out hover:bg-white dark:hover:bg-meta-4 ${
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-bold text-black duration-300 ease-in-out hover:bg-white dark:text-white dark:hover:bg-primaryColor ${
                          (pathname === '/auth' || pathname.includes('auth')) &&
                          'bg-white dark:bg-primaryColor dark:primaryColor'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
